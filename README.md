...
Задание содержит 25 задач. Выполнены задачи 1--23 (включая бонусные). Остаются задачи 24--25.
...
Открываем `portfolio_analysis.ipynb` и выполняем ячейки. Все данные уже лежат в `data/` -- ничего скачивать не нужно. Для Excel: сводный файл `data/export/data_export.xlsx` содержит все основные данные на 35 листах.
...
```
portfolio_analysis.ipynb          # основной ноутбук (задачи 1--23)
README.md                         # этот файл
...
**data/processed/** -- обработанные данные (задачи 1--23):
...
| Файл | Описание |
|------|----------|
| `data_export.xlsx` | Все данные в Excel (35 листов, описание на листе spravka) |
...
19 файлов с тестами (pytest), проверяют корректность данных и расчётов по всем задачам:
